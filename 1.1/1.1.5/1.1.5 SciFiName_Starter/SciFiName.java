...
public class SciFiName   
{
    ...
    public static void main()
    {
        ...
        String scifiFirst = firstName + lastName;
        
        city = city.substring(0,2);
        school = school.substring(0,3);
        String scifiLast = city + school;
        
        int random1 = (int)(Math.random()*(relativeName1.length()-1)+1);
        String relative1 = relativeName1.substring(random1);
        int random2 = (int)(Math.random()*(relativeName2.length()-1)+1);
        String relative2 = relativeName2.substring(random2);
        System.out.println("Hello " + scifiFirst + " " + scifiLast + " of " + relative1 + relative2 + ", Welcome.");
    }
}
